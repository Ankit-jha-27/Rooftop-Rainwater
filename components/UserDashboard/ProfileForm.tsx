...
---------------------------------------------------------------- */
  ...
  async function uploadToCloudinary(file: File) {
    const CLOUD_NAME = "dyjd9ydts";
    const UPLOAD_PRESET = "rtrwh-products";
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 w-full">
      ...
      "
                  >
                    ...
                    <option value="Andhra Pradesh" className="text-white">
                      Andhra Pradesh
                    </option>
                    <option value="Arunachal Pradesh" className="text-white">
                      Arunachal Pradesh
                    </option>
                    <option value="Assam" className="text-white">
                      Assam
                    </option>
                    <option value="Bihar" className="text-white">
                      Bihar
                    </option>
                    <option value="Chhattisgarh" className="text-white">
                      Chhattisgarh
                    </option>
                    <option value="Goa" className="text-white">
                      Goa
                    </option>
                    <option value="Gujarat" className="text-white">
                      Gujarat
                    </option>
                    <option value="Haryana" className="text-white">
                      Haryana
                    </option>
                    <option value="Himachal Pradesh" className="text-white">
                      Himachal Pradesh
                    </option>
                    <option value="Jharkhand" className="text-white">
                      Jharkhand
                    </option>
                    <option value="Karnataka" className="text-white">
                      Karnataka
                    </option>
                    <option value="Kerala" className="text-white">
                      Kerala
                    </option>
                    <option value="Madhya Pradesh" className="text-white">
                      Madhya Pradesh
                    </option>
                    <option value="Maharashtra" className="text-white">
                      Maharashtra
                    </option>
                    <option value="Manipur" className="text-white">
                      Manipur
                    </option>
                    <option value="Meghalaya" className="text-white">
                      Meghalaya
                    </option>
                    <option value="Mizoram" className="text-white">
                      Mizoram
                    </option>
                    <option value="Nagaland" className="text-white">
                      Nagaland
                    </option>
                    <option value="Odisha" className="text-white">
                      Odisha
                    </option>
                    <option value="Punjab" className="text-white">
                      Punjab
                    </option>
                    <option value="Rajasthan" className="text-white">
                      Rajasthan
                    </option>
                    <option value="Sikkim" className="text-white">
                      Sikkim
                    </option>
                    <option value="Tamil Nadu" className="text-white">
                      Tamil Nadu
                    </option>
                    <option value="Telangana" className="text-white">
                      Telangana
                    </option>
                    <option value="Tripura" className="text-white">
                      Tripura
                    </option>
                    <option value="Uttar Pradesh" className="text-white">
                      Uttar Pradesh
                    </option>
                    <option value="Uttarakhand" className="text-white">
                      Uttarakhand
                    </option>
      ...
      <div className="relative right-30 p-8 rounded-2xl bg-slate-900 border border-slate-700">
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="flex flex-col items-center gap-4">
            {/* Avatar Preview */}
            <div className="w-28 h-28 rounded-xl overflow-hidden border border-slate-700 bg-slate-800">
              {profilePic ? (
            ...
            {/* Upload Button */}
            <label className="px-4 py-2 rounded-lg bg-teal-600 text-white text-sm cursor-pointer hover:bg-teal-500 transition">
              Change Picture
              <input
                type="file"
                accept="image/*"
