...
Analyze the user's rooftop and environmental suitability and recommend the MOST appropriate recharge/storage structure.
...
{
  "structure": "<recommended structure name based on rooftop area, roof type, no.of dwellers and open space>",
...
- Always fill all dictionary fields.
    ...
    const genAI = new GoogleGenerativeAI(
      "AIzaSyA8YjNJIXX12vtKv0CX87nTGXrLNiW1aqE"
    );
